...
public class HomoglyphBenchmark {
    @Param({"false","true"}) public boolean preserveOriginal;
    @Param({"ordinary-text","tℯst😀","ооооооо","microsoft","a\u0315\u0300"}) public String text;
    private TokenProcessor processor;
    private char[] input;
    private Analyzer analyzer;
    @Setup public void setup() {
        Configuration configuration = new Configuration(Map.of("preserve_original",Boolean.toString(preserveOriginal)));
